...
export function SearchToolCard({ item, actions }: { item: TranscriptItem; actions?: ReactNode }) {
  ...
  return (
    <div
      ...
      className={cn(
        "message tool tool-card-search group/row relative mx-4 my-1 min-w-0 overflow-hidden rounded-[10px] border text-sm",
