...
- Added a `repeated-image-artifact-paths` Playwright regression scenario to cover repeated local screenshot paths across assistant messages and include it in the full fake-agent scenario set.
