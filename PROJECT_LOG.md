...
1. Continue transcript noise reduction: dogfood the new completed-tool grouping/live+snapshot tool-call compaction and duplicate tool-result merging, then consider terminal-output viewport sizing, local image artifact thumbnail sizing, and queue chips after real-session dogfooding.
